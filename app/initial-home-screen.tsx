...
import { Wifi, MessageSquare, AppleIcon as Safari, Camera, Phone } from "lucide-react"
...
export default function InitialHomeScreen({ onNotificationClick, isConnectedToWifi }: InitialHomeScreenProps) {
  const appIcons = [
    ...
    { name: "Safari", icon: <Safari className="w-6 h-6 text-white" />, bgColor: "bg-blue-500" },
    { name: "Camera", icon: <Camera className="w-6 h-6 text-white" />, bgColor: "bg-gray-600" },
  ]

  return (
    <div className="w-[393px] h-[852px] bg-black flex flex-col mx-auto relative overflow-hidden">
      {/* Dynamic Island Area */}
      ...
      >
        ...
        {/* Removed ChevronRight as it's not needed for a text message look */}
      </div>
